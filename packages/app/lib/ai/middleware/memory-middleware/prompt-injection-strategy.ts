...
const transformParams: MemoryMiddlewareAugmentationStrategy['transformParams'] = async ({ params }) => {
...
export const promptInjectionStrategyFactory = (): MemoryMiddlewareAugmentationStrategy => ({
  transformParams,
  onOutputGenerated,
});

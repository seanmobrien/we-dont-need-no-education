...
const Modal = ({ isOpen, onClose, onSave, title, children, closeButtonText = 'Close', }) => {
    if (!isOpen)
        return null;
    return (<div css={modalStyles.overlay}>
      <div css={modalStyles.content}>
        ...
        <div css={modalStyles.footer}>
          {onSave && (<button css={modalStyles.saveButton} onClick={onSave}>
              Save
            </button>)}

...
export const EmailMasterPanel = ({ row: { value, policy_basis, tags, categoryName, propertyId }, title, children, }) => {
    ...
    const MemoizedHeader = useMemo(() => {
        ...
        <Paper elevation={2} sx={styles.paperDescription}>
          <Typography variant="body1" align="left" sx={isEmailHeader
    ...
    const MemoizedFooter = useMemo(() => {
        return (<Box component="section" sx={styles.footerBox}>
        <Typography variant="body2" color="textSecondary" align="left" sx={styles.padBottomHalf}>
          Policy Basis
        </Typography>
        <Typography variant="body1" align="left" component="div">
          {policyList
                ? policyList
                    .split('|')
                    .map((item) => (<Chip key={item} label={item} style={styles.marginTwo}/>))
                : 'No policy basis specified'}
        </Typography>

        <Typography variant="body2" color="textSecondary" align="left" sx={styles.padTags}>
          Tags
        </Typography>
        <Typography variant="body1" align="left" component="div">
          {tagsList
    ...
    return (<Stack sx={styles.stack} direction="column">
...
//# sourceMappingURL=EmailMasterPanel.jsx.map
...
const config = {
  ...
  moduleNameMapper: {
    ...
    '^@tanstack/react-query-devtools$': '<rootDir>/node_modules/@tanstack/react-query-devtools/build/modern/index.cjs',
    '^@tanstack/react-query-devtools/production$': '<rootDir>/node_modules/@tanstack/react-query-devtools/build/modern/production.cjs',

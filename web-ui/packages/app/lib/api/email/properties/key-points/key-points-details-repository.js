...
export class KeyPointsDetailsRepository extends BaseObjectRepository {
    ...
    getCreateQueryProperties({ propertyId, value, documentId, tags, policy_basis, createdOn, relevance, compliance, severity: severityRanking, inferred, }) {
        return [
            `WITH ins1 AS (
    ...
    getUpdateQueryProperties({ relevance, compliance, severity: severityRanking, inferred, }) {
        return [
            {
...
//# sourceMappingURL=key-points-details-repository.js.map
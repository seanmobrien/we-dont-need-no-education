...
export class ViolationDetailsRepository extends BaseObjectRepository {
    ...
    getCreateQueryProperties({ propertyId, attachmentId, keyPointPropertyId, actionPropertyId, violationType, severityLevel, detectedBy, detectedOn, value, documentId, policy_basis, tags, createdOn, }) {
        return [
            `WITH ins1 AS (
    ...
    getUpdateQueryProperties({ attachmentId, keyPointPropertyId, actionPropertyId, violationType, severityLevel, detectedBy, detectedOn, }) {
        return [
            {
...
//# sourceMappingURL=violation-details-repository.js.map
declare module '@/lib/nextjs-util/client-navigate' {
  /**
   ...
   * @returns This function does not return a value as it triggers a page reload
   *
   ...
   * @returns This function does not return a value as it triggers navigation
   *

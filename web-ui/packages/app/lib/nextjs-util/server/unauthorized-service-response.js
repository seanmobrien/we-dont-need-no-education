...
export const unauthorizedServiceResponse = ({ req, scopes = [], } = {}) => {
    ...
    return NextResponse.json({ error: 'Unauthorized', message: 'Active session required.' }, {
...
//# sourceMappingURL=unauthorized-service-response.js.map
...
declare module '@/lib/send-api-request/types' {
   ...
   *
   * @property url - The URL to which the request is made
   * @property area - The area or domain of the API being accessed
   * @property action - The specific action or endpoint being called
   * @property method - The HTTP method used for the request
   * @property input - Optional input data to be sent with the request, can be a string or an object
   * @property req - The active request object
   * @property forwardCredentials - Whether to forward credentials to the endpoint. True by default when the request property is provided
   */
   ...
   * @param apiRequest - The parameters for the API request
   ...
   *
   * @property sendApiRequest - An optional function that can be used for dependency injection to override the default API request function
   */
   ...
   *
   * Provides convenience methods for GET, POST, PUT, and DELETE HTTP operations
   * with type-safe parameters and cancellable promises.
   *
   * @template T - The type of the response data
   */

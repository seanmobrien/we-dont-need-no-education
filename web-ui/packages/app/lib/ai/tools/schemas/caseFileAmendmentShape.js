...
export const CaseFileAmendmentShape = z
    ...
    .describe('Describes the changes to make to a case file.  Properties that are not set will maintain current values.  When updating a Rating field the associated Reasons field must contain at least 3 values - eg changing the severityRating value necessitates passing 3 or more strings in the severityReasons property.');
//# sourceMappingURL=caseFileAmendmentShape.js.map
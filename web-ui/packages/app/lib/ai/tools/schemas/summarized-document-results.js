...
export const SummarizedDocumentSchema = z.object({
    ...
    relatedDocuments: z
        ...
        relationshipType: z
            .string()
            .describe('Type of relationship (e.g., "supports", "responds to", "contradicts")'),
        documentType: z
            .string()
            .describe('Type of the related document (call to action, note, etc, email, etc)'),
        excerpt: z
            .string()
            .optional()
            .nullable()
...
//# sourceMappingURL=summarized-document-results.js.map
...
const referencedEmailShape = z.object({
    ...
    emailAttachments: z.array(z.object({
...
export const DocumentSchema = z.object({
    ...
    documentPropertyId: z
        ...
        .nullable()
        .optional()
        .describe('Document property ID associated with the document.  While unitId / documentId is the preferred identifier, this value can be used to refer to this record in some tools.'),
  ...
  - 'cta_response': represents an action taken at least purportedly in response to a call to action.`),
    ...
    email: z
        ...
        emailAttachments: z
            ...
            docs: z
                ...
                unitId: z
                    ...
                    .optional()
                    .nullable()
                    .describe('Case file Id assigned to the attachment.  This value can be passed to getCaseFileDocument and similar tools to retreive attachment conntent and additional information.'),
            }))
                .nullable()
                .optional(),
        }))
        ...
        inReplyTo: referencedEmailShape
            .optional()
            .nullable()
            .describe('Details of the email this case file is a reply to, if applicable.'),
        repliesTo: z
            .array(referencedEmailShape)
            .optional()
            .nullable()
            .describe('Details of emails sent to this case file is a reply to, if applicable.'),
    })
        .nullable()
        .optional()
    ...
    docRel_targetDoc: z
        ...
        z.object({
            ...
            description: z
                ...
                .describe('Description of the relationship.  Some examples include "supports", "responds to", "contradicts", etc.'),
            sourceDoc: z.object({
                documentType: z
                    .string()
        ...
        .nullable()
        .optional()
        .describe('Relationships to other documents, where this document is the target.'),
    docRel_sourceDoc: z
        .array(z.union([
        z.object({
        ...
        .nullable()
        .optional()
        .describe('Relationships to other documents, where this document is the source.'),
});
//# sourceMappingURL=case-file-shape.js.map
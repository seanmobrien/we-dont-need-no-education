...
export const documentPropertyShape = {
    columns: {
        ...
        doc: {
            ...
            with: {
                docRel_targetDoc: {
                    ...
                    extras: {
                        relationship: sql `(SELECT description FROM document_relationship_reason WHERE relation_reason_id = relationship_reason_id)`.as('relationshipDescription'),
                    },
                },
            },
        },
...
export const caseFileDocumentShape = {
    columns: {
        unitId: true,
        attachmentId: true,
    ...
    with: {
        docRel_sourceDoc: {
            ...
            extras: {
                description: sql `(SELECT description FROM document_relationship_reason WHERE relation_reason_id = relationship_reason_id)`.as('description'),
            },
        },
        docRel_targetDoc: {
            columns: {
        ...
        docProps: {
            ...
            where: (dp, { inArray }) => inArray(dp.documentPropertyTypeId, [
                4,
                5,
                6,
                7,
...
//# sourceMappingURL=case-file-document-query.js.map
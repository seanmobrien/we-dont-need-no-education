...
const strategyFactory = (context: MemoryMiddlewareContext): Array<[string, MemoryMiddlewareAugmentationStrategy]> => {
      ...
      >({
        async transform(chunk, controller) {
          try {
            ...
            log(l => l.warn('Error processing chunk in memory middleware', { error: e }));
          }
        ...
        async flush() {
          ...
          try {
            ...
            const output = streamContext.generatedJSON as Array<LanguageModelV2Content>;

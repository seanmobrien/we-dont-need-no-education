...
export const onOutputGenerated = async ({ output, params: { prompt: promptFromProps }, context: { memClient }, }) => {
    try {
        const mostRecentExchangeIndex = promptFromProps.findIndex((x) => x.role === 'assistant') + 1;
        const mostRecentExchange = {
            role: 'user',
...
${JSON.stringify([
        ...
        const conversationContext = mostRecentExchangeIndex > 0
            ? {
                role: 'user',
...
//# sourceMappingURL=output-generated.js.map
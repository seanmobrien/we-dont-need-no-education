...
const Page = async ({ params }) => {
    ...
    const emailId = await resolveEmailIdWithRedirect(emailIdParam, `/messages/email/[emailId]/call-to-action/${propertyId}/timeline`);
    if (!emailId) {
        notFound();
    }
    return (<EmailDashboardLayout session={session}>
      <Box sx={{
        ...
        <TimelineAgentInterface initialDocumentId={emailId} caseId={propertyId}/>
      </Box>

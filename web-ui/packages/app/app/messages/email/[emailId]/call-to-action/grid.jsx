'use client';
import { defineReasonsColumn, EmailPropertyDataGrid, SharedCellDefinitions, valueFormatterPercentageIntegerBaseTen, valueGetterDate, } from '@/components/mui/data-grid';
...
const CtaGrid = () => {
    const getDetailPanelContent = useCallback(({ row }) => <CallToActionPanel row={row}/>, []);
    const getDetailPanelHeight = useCallback(() => 'auto', []);
    return (<EmailPropertyDataGrid property="call-to-action" columns={stableColumns} initialState={stableInitialState} getDetailPanelContent={getDetailPanelContent} getDetailPanelHeight={getDetailPanelHeight}/>);
};

      ...
      <Container maxWidth="lg">
        <Box sx={{
          ...
          <Box sx={{ mb: 4, display: 'flex', justifyContent: 'center' }}>
            ...
            : '/static/logo/logo-light.png'} alt="Title IX Advocacy Platform" width={200} height={200} priority style={{ maxWidth: '200px', height: 'auto' }}/>
          </Box>
          ...
          <Box sx={{
            ...
            <Button variant="contained" size="large" onClick={handleGetStarted} sx={{
            ...
            <Button variant="outlined" size="large" onClick={() => router.push('/privacy')} sx={{
        ...
        <Box sx={{ py: { xs: 6, md: 10 } }}>
          ...
          <Box sx={{
            ...
            {features.map((feature, index) => (<Card key={index} sx={{
                height: '100%',
        ...
        <Box sx={{
          ...
          <Box sx={{
            ...
            <Button variant="text" size="small" href="https://github.com/seanmobrien/we-dont-need-no-education" target="_blank" sx={{ color: 'var(--color-primary-main)' }}>
              GitHub Repository
            </Button>
            <Button variant="text" size="small" href="https://github.com/seanmobrien/mem0" target="_blank" sx={{ color: 'var(--color-primary-main)' }}>
              Memory System (mem0)
            </Button>
            <Button variant="text" size="small" onClick={() => router.push('/privacy')} sx={{ color: 'var(--color-primary-main)' }}>
              Privacy Policy
            </Button>
            <Button variant="text" size="small" onClick={() => router.push('/terms')} sx={{ color: 'var(--color-primary-main)' }}>
              Terms of Service
            </Button>
          </Box>
        </Box>

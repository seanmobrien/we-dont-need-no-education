...
export const GET = wrapRouteRequest(
  async (req: NextRequest, args: { params: Promise<{ emailId: string }> }) => {
    ...
    const baseQuery = db
      .select({
        ...
        compliance_average_chapter_13:
          sql`(SELECT AVG("call_to_action_details_call_to_action_response".compliance_chapter_13) FROM "call_to_action_details_call_to_action_response" WHERE "call_to_action_details_call_to_action_response".call_to_action_response_id = "document_property".property_id )`.as(
            'compliance_average_chapter_13',
          ),
    ...
    ): Partial<CallToActionResponseDetails> => {
      return {

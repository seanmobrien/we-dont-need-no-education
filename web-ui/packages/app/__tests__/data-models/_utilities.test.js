import { EmailPropertyTypeTypeValues, EmailPropertyCategoryTypeValues, } from '@/data-models/api/email-properties/property-type';
import { isEmailPropertyCategory, isEmailPropertyType, lookupEmailPropertyCategory, lookupEmailPropertyType, normalizeDateAndTime, normalizeNullableNumeric, } from '@/data-models/_utilities';
...
describe('normalizeDateAndTime', () => {
    ...
    it('should return the default value if the input is invalid', () => {
        ...
        expect(normalizeDateAndTime('invalid-date', defaultValue)).toBe('2023-10-10T10:10');
    });
...
describe('lookupEmailPropertyType', () => {
    it('should return the correct ID for a known property type', () => {
        expect(lookupEmailPropertyType('Cc')).toBe(EmailPropertyTypeTypeValues.indexOf('Cc') + 1);
    });
...
describe('lookupEmailPropertyCategory', () => {
    it('should return the correct ID for a known property category', () => {
        expect(lookupEmailPropertyCategory('Key Point')).toBe(EmailPropertyCategoryTypeValues.indexOf('Key Point') + 1);
    });
...
//# sourceMappingURL=_utilities.test.js.map
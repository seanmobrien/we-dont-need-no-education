...
describe('UrlBuilder', () => {
    ...
    beforeEach(() => {
        env.mockImplementation(() => hostname);
    });
    ...
    it('should create child URL', () => {
        ...
        expect(childBuilder.url.toString()).toBe(`${hostname}/child-segment/child-slug`);
    });
    ...
    describe('UrlBuilder.page', () => {
        ...
        it('should append query parameters if slug is an object', () => {
            ...
            expect(url.toString()).toBe(`${hostname}/about?param1=value1&param2=value2`);
        });
        it('should throw an error if slug contains a slash', () => {
            const builder = UrlBuilder.rootBuilder;
            expect(() => builder.page('about', 'team/us')).toThrow('Invalid slug name.');
        });
        it('should return a URL with the page, slug, and query parameters if all are provided', () => {
            ...
            expect(url.toString()).toBe(`${hostname}/about/team?param1=value1&param2=value2`);
        });
    });
});

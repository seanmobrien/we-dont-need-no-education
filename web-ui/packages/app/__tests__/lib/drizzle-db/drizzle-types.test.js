import { errorFromCode, PG_ERROR_CODE_DESCRIPTIONS, } from '@compliance-theater/database';
describe('Postgres error code helpers', () => {
    ...
    test('PG_ERROR_CODE_DESCRIPTIONS contains expected entries', () => {
        ...
        expect(PG_ERROR_CODE_DESCRIPTIONS['22P02']).toBe('invalid_text_representation');
    });
...
//# sourceMappingURL=drizzle-types.test.js.map
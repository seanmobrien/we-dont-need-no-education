...
jest.mock('@/lib/typescript/guards', () => {
  const origModule = jest.requireActual(
    '@/lib/typescript/guards',
  ) as typeof import('@/lib/typescript/guards');
  return {
    ...origModule,
    isValidUuid: jest.fn(),
  };
...
import { isValidUuid } from '@compliance-theater/typescript/guards';

import { BracketHeaderParser, EmailHeaderParser, isParsedHeaderMap, ParsedHeaderMap, } from '@/lib/email/parsedHeaderMap';
describe('ParsedHeaderMap', () => {
    ...
    describe('getFirstValueOrDefault', () => {
        it('should return the first value associated with the key', () => {
            ...
            expect(map.getFirstValueOrDefault('To', 'default@example.com')).toBe('recipient@example.com');
        });
        it('should return the default value if the key does not exist', () => {
            const map = new ParsedHeaderMap();
            expect(map.getFirstValueOrDefault('NonExistent', 'default@example.com')).toBe('default@example.com');
        });
    });
    ...
    describe('headerContactToString', () => {
        ...
        it('should return the email if name is not available', () => {
            ...
            expect(ParsedHeaderMap.headerContactToString(contact)).toBe('john@example.com');
        });
    });
...
//# sourceMappingURL=parsedHeaderMap.test.js.map
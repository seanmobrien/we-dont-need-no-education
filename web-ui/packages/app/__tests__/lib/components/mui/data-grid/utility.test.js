import { parseSortOptions, parseFilterOptions, } from '@/lib/components/mui/data-grid/server';
describe('utility functions', () => {
    ...
    describe('parseSortOptions edge cases', () => {
        it('returns empty array for null input', () => {
            expect(parseSortOptions(null)).toEqual([]);
        });
        it('returns undefined for non-URL, non-URLSearchParams, non-array input', () => {
            expect(parseSortOptions({})).toBeUndefined();
            expect(parseSortOptions(123)).toBeUndefined();
    ...
    describe('parseFilterOptions', () => {
        ...
        it('parses filter from URL', () => {
            ...
            const url = new URL('http://localhost?filter=' + encodeURIComponent(JSON.stringify(filter)));

...
describe('AuthorizationService', () => {
    ...
    const mockDecodeToken = decodeToken;
    beforeEach(() => {
        jest.clearAllMocks();
    });
    describe('getUserEntitlements', () => {
        ...
        it('should return entitlements when RPT exchange is successful', async () => {
            ...
            expect(mockFetch).toHaveBeenCalledWith(expect.stringContaining('/token'), expect.objectContaining({
                method: 'POST',

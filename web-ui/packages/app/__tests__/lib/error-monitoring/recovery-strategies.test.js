...
import { classifyError, getRecoveryActions, getDefaultRecoveryAction, attemptAutoRecovery, ErrorType, recoveryStrategies, } from '@/lib/error-monitoring/recovery-strategies';
    ...
    describe('getDefaultRecoveryAction', () => {
        ...
        it('should return first action if no default is specified', async () => {
            ...
            if (strategyWithoutDefault) {
                jest
                    .spyOn(await import('@/lib/error-monitoring/recovery-strategies'), 'classifyError')
...
describe('Recovery Action Execution', () => {
    ...
    describe('Permission Error Actions', () => {
        it('should execute contact-admin action', () => {
            ...
            expect(mockAlert).toHaveBeenCalledWith('You do not have permission to perform this action. Please contact your administrator.');
        });
...
describe('Automatic Recovery', () => {
    ...
    describe('attemptAutoRecovery', () => {
        ...
        it('should return false for errors without default actions', async () => {
            jest
                .spyOn(await import('@/lib/error-monitoring/recovery-strategies'), 'getDefaultRecoveryAction')
    ...
    it('should have valid default actions when specified', () => {
        recoveryStrategies.forEach((strategy) => {
            if (strategy.defaultAction) {
                const defaultActionExists = strategy.actions.some((action) => action.id === strategy.defaultAction);
...
//# sourceMappingURL=recovery-strategies.test.js.map
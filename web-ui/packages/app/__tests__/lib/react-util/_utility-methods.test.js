import { generateUniqueId, isError, isAbortError, isTemplateStringsArray, isTruthy, isRecord, TypeBrandSymbol, isTypeBranded, getResolvedPromises, } from '@/lib/react-util/utility-methods';
describe('_utility-methods', () => {
    ...
    describe('isTemplateStringsArray', () => {
        it('should return true for template strings array', () => {
            const templateFn = (strings, ..._values) => strings;
    ...
    describe('getResolvedPromises', () => {
        ...
        it('should categorize timed out promises as pending', async () => {
            const slowPromise1 = new Promise((resolve) => setTimeout(() => resolve('slow1'), 2000));
            const slowPromise2 = new Promise((resolve) => setTimeout(() => resolve('slow2'), 3000));
        ...
        it('should handle custom timeout values', async () => {
            ...
            const resultPromise = getResolvedPromises(promises, 100);
...
//# sourceMappingURL=_utility-methods.test.js.map
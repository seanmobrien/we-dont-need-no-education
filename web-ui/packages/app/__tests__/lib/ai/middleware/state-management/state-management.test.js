import { STATE_PROTOCOL, MiddlewareStateManager, } from '@/lib/ai/middleware/state-management';
describe('State Management Protocol', () => {
    describe('MiddlewareStateManager', () => {
        ...
        it('should provide middleware implementation', () => {
            const middleware = MiddlewareStateManager.Instance.getMiddlewareInstance();

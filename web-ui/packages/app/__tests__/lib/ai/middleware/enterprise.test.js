...
import { withRedisConnection, } from '@/__tests__/setup/jest.setup';
import { getCacheConfig, validateCacheConfig, } from '@/lib/ai/middleware/cacheWithRedis/config';
import { metricsCollector, setupConsoleMetrics, getPrometheusMetrics, } from '@/lib/ai/middleware/cacheWithRedis/metrics';
...
describe('Enterprise Cache Features', () => {
    ...
    describe('Configuration Management', () => {
        ...
        it('should reject invalid configuration', () => {
            ...
            expect(() => validateCacheConfig(invalidConfig)).toThrow('Cache TTL must be positive');
        });
    ...
    describe('Metrics Collection', () => {
        it('should track cache hits and misses', () => {
            ...
            expect(metrics.hitRate).toBeCloseTo(0.6667);
            expect(metrics.avgResponseSize).toBeCloseTo(100);
        });
        ...
        it('should generate Prometheus metrics', () => {
            ...
            expect(prometheusMetrics).toContain('# HELP ai_cache_hits_total Total number of cache hits');
        });

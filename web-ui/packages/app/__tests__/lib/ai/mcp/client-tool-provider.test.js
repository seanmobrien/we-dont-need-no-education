...
describe('clientToolProviderFactory', () => {
    ...
    describe('askConfirmation tool', () => {
        it('should have the correct description and parameters schema', () => {
            ...
            expect(tool.description).toBe('Ask the user for confirmation before proceeding.  Returns an empty string if the user rejects the request, otherwise a confirmation hash.');
    ...
    describe('openCaseFile tool', () => {
        it('should have the correct description and parameters schema', () => {
            ...
            expect(tool.description).toBe("Opens a case file on the user's desktop.  This tool is useful when a ");
            const schema = tool.inputSchema;
            expect(() => {
...
//# sourceMappingURL=client-tool-provider.test.js.map
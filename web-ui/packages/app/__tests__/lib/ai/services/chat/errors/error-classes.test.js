...
import { isAbortChatMessageRequestError, isMessageTooLargeForQueueError, } from '@/lib/react-util/core';
describe('AbortChatMessageRequestError', () => {
    describe('Constructor and Properties', () => {
        ...
        it('should create error with undefined requestId', () => {
            const error = new AbortChatMessageRequestError(undefined);
            expect(error.name).toBe('AbortChatMessageRequestError');
...
//# sourceMappingURL=error-classes.test.js.map
...
describe('ToolMap', () => {
    ...
    test('setupMockInstance seeds records and Instance is available', async () => {
        ...
        expect(map.allIds.sort()).toEqual([toolA.chatToolId, toolB.chatToolId].sort());
        expect(map.allNames.sort()).toEqual([toolA.toolName, toolB.toolName].sort());
...
//# sourceMappingURL=tool-map.test.js.map
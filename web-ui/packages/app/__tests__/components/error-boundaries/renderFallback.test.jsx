...
describe('RenderErrorBoundaryFallback', () => {
    ...
    const renderComponent = (error = testError, resetFn = mockResetErrorBoundary) => {
        ...
        <RenderErrorBoundaryFallback error={error} resetErrorBoundaryAction={resetFn}/>
      </TestWrapper>);
    };
    describe('Basic Rendering', () => {
        ...
        it('should handle non-Error objects', () => {
            renderComponent('String error message');
    ...
    describe('Recovery Actions', () => {
        ...
        it('should highlight default recovery action', () => {
            ...
            const recoveryActionButton = retryButtons.find((button) => button.closest('button')?.classList.contains('MuiButton-contained'));
    ...
    describe('Dialog Actions', () => {
        ...
        it('should show generic Try Again when no default action', () => {
            ...
            const dialogActionButton = tryAgainButtons.find((button) => button.closest('button')?.classList.contains('MuiButton-contained'));
    ...
    describe('Accessibility', () => {
        ...
        it('should focus on Try Again button by default', () => {
            ...
            const dialogActionButton = tryAgainButtons
                .find((button) => button.closest('button')?.classList.contains('MuiButton-contained'))
                ?.closest('button');
            expect(dialogActionButton).toBeInTheDocument();
    ...
    describe('Theme Integration', () => {
        ...
        it('should adapt to dark theme', () => {
          ...
          <RenderErrorBoundaryFallback error={testError} resetErrorBoundaryAction={mockResetErrorBoundary}/>
        </ThemeProvider>);
            expect(screen.getByRole('dialog')).toBeInTheDocument();
        });
    });
});
//# sourceMappingURL=renderFallback.test.jsx.map
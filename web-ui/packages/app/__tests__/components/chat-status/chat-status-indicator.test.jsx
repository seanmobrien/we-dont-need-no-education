...
describe('ChatStatusIndicator', () => {
    ...
    it('provides appropriate tooltip content', () => {
        ...
        expect(tooltipElement).toHaveAttribute('aria-label', expect.stringContaining('Chat service is healthy'));
    });
    it('shows subsystem details in tooltip when services are degraded', () => {
        ...
        const tooltipElement = container.querySelector('[aria-label]');
        expect(tooltipElement).toBeInTheDocument();
        expect(tooltipElement).toHaveAttribute('aria-label', expect.stringContaining('Queue'));
    });
});
//# sourceMappingURL=chat-status-indicator.test.jsx.map
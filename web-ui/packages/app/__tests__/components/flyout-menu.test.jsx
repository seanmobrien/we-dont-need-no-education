...
describe('FlyoutMenu', () => {
    ...
    describe('Rendering', () => {
        it('renders with label', () => {
            render(<FlyoutMenu {...defaultProps}>
        ...
        it('renders with icon when provided', () => {
            ...
            render(<FlyoutMenu {...defaultProps} icon={icon}>
          <MenuItem>Child Item</MenuItem>
        </FlyoutMenu>);
            expect(screen.getByTestId('test-icon')).toBeInTheDocument();
        });
        it('renders with custom data-testid', () => {
            render(<FlyoutMenu {...defaultProps} dataTestId="custom-menu">
          <MenuItem>Child Item</MenuItem>
        </FlyoutMenu>);
            expect(screen.getByTestId('custom-menu')).toBeInTheDocument();
        });
        it('applies active state when active prop is true', () => {
            render(<FlyoutMenu {...defaultProps} active={true} dataTestId="active-menu">
          <MenuItem>Child Item</MenuItem>
        </FlyoutMenu>);
        ...
        it('renders children in flyout menu', () => {
            render(<FlyoutMenu {...defaultProps} isOpen={true}>
    ...
    describe('Hover Interactions', () => {
        it('calls onHover when mouse enters', () => {
            ...
            render(<FlyoutMenu {...defaultProps} onHover={onHover} dataTestId="hover-menu">
          <MenuItem>Child Item</MenuItem>
        </FlyoutMenu>);
        ...
        it('opens submenu on mouse enter', async () => {
            render(<FlyoutMenu {...defaultProps} isOpen={true} dataTestId="hover-menu">
        ...
        it('shows submenu only when isOpen is true', async () => {
            const { rerender } = render(<FlyoutMenu {...defaultProps} isOpen={false} dataTestId="hover-menu">
          <MenuItem data-testid="child-item">Child Item</MenuItem>
        </FlyoutMenu>, {
                chatPanel: true,
            });
            ...
            rerender(<FlyoutMenu {...defaultProps} isOpen={true} dataTestId="hover-menu">
          <MenuItem data-testid="child-item">Child Item</MenuItem>
        </FlyoutMenu>, {
                chatPanel: true,
            });
    ...
    describe('Click Interactions', () => {
        it('calls onHover when clicked', () => {
            const onHover = jest.fn();
            render(<FlyoutMenu {...defaultProps} onHover={onHover} dataTestId="click-menu">
          <MenuItem>Child Item</MenuItem>
        </FlyoutMenu>);
        ...
        it('stops propagation on click', () => {
            ...
            const { container } = render(<div onClick={parentClickHandler}>
        ...
        it('opens submenu when clicked', async () => {
            render(<FlyoutMenu {...defaultProps} isOpen={true} dataTestId="click-menu">
          <MenuItem data-testid="child-item">Child Item</MenuItem>
        </FlyoutMenu>);
            const menuItem = screen.getByTestId('click-menu');
            fireEvent.click(menuItem);
    ...
    describe('Menu Positioning', () => {
        it('positions submenu correctly relative to parent', async () => {
            render(<FlyoutMenu {...defaultProps} isOpen={true} dataTestId="position-menu">
          <MenuItem data-testid="child-item">Child Item</MenuItem>
        </FlyoutMenu>);
    ...
    describe('Prop Handling', () => {
        it('handles missing optional props gracefully', () => {
            render(<FlyoutMenu label="Minimal Menu" isOpen={false} onHover={jest.fn()}>
          <MenuItem>Child Item</MenuItem>
        </FlyoutMenu>);
        ...
        it('handles all props provided', () => {
            ...
            const onHover = jest.fn();
            render(<FlyoutMenu label="Full Menu" icon={icon} active={true} dataTestId="full-menu" isOpen={true} onHover={onHover}>
          <MenuItem>Child Item</MenuItem>
        </FlyoutMenu>);
        ...
        it('updates when props change', () => {
            const { rerender } = render(<FlyoutMenu {...defaultProps} label="Original Label" dataTestId="prop-menu">
          <MenuItem>Child Item</MenuItem>
        </FlyoutMenu>);
            expect(screen.getByText('Original Label')).toBeInTheDocument();
            rerender(<FlyoutMenu {...defaultProps} label="Updated Label" dataTestId="prop-menu">
          <MenuItem>Child Item</MenuItem>
        </FlyoutMenu>);
    ...
    describe('Menu Opening and Closing', () => {
        it('opens menu when hovering and isOpen is true', async () => {
            render(<FlyoutMenu {...defaultProps} isOpen={true} dataTestId="close-menu">
          <MenuItem data-testid="child-item">Child Item</MenuItem>
        </FlyoutMenu>);
        ...
        it('does not open menu when hovering and isOpen is false', () => {
            render(<FlyoutMenu {...defaultProps} isOpen={false} dataTestId="no-open-menu">
          <MenuItem data-testid="child-item">Child Item</MenuItem>
        </FlyoutMenu>);
    ...
    describe('Accessibility', () => {
        it('renders with proper ARIA attributes', () => {
            render(<FlyoutMenu {...defaultProps} dataTestId="aria-menu">
          <MenuItem>Child Item</MenuItem>
        </FlyoutMenu>);
...
//# sourceMappingURL=flyout-menu.test.jsx.map
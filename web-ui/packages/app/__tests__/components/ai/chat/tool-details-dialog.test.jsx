...
describe('ToolDetailsDialog', () => {
    ...
    it('should not render when open is false', () => {
        render(<ToolDetailsDialog open={false} onClose={mockOnClose} message={mockToolMessage}/>);
        expect(screen.queryByRole('dialog', { name: /tool details/i })).not.toBeInTheDocument();
    });
    it('should render when open is true', () => {
        render(<ToolDetailsDialog open={true} onClose={mockOnClose} message={mockToolMessage}/>);
    ...
    it('should handle message with no functionCall', () => {
        ...
        render(<ToolDetailsDialog open={true} onClose={mockOnClose} message={messageWithoutFunctionCall}/>);
    ...
    it('should handle message with no toolResult', () => {
        ...
        render(<ToolDetailsDialog open={true} onClose={mockOnClose} message={messageWithoutToolResult}/>);
    ...
    it('should display primitive values inline', () => {
        ...
        render(<ToolDetailsDialog open={true} onClose={mockOnClose} message={messageWithPrimitives}/>);
    ...
    it('should handle message with no tool name', () => {
        ...
        render(<ToolDetailsDialog open={true} onClose={mockOnClose} message={messageWithoutToolName}/>);
        expect(screen.getByText('Unknown Tool')).toBeInTheDocument();
    });
});
//# sourceMappingURL=tool-details-dialog.test.jsx.map
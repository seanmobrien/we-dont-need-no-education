...
jest.mock('@/components/ai/chat/chat-message-display', () => ({
    ChatMessageDisplay: ({ message, showMetadata }) => (<div data-testid={`message-${message.messageId}`} data-show-metadata={String(showMetadata)}>
...
//# sourceMappingURL=chat-turn-display.test.jsx.map
...
jest.mock('/components/email-message/dashboard-layout/email-dashboard-layout', () => {
    const MockEmailDashboardLayout = React.forwardRef((props, ref) => (<div ref={ref} data-testid="email-dashboard-layout">
        {props.children}
      </div>));
...
jest.mock('/components/email-message/dashboard-layout/custom-email-page-item', () => {
    const MockCustomEmailPageItem = React.forwardRef((props, ref) => <div ref={ref} data-testid="custom-email-page-item"/>);
...
jest.mock('/components/email-message/dashboard-layout/email-dashboard-toolbar-action', () => {
    const MockEmailDashboardToolbarAction = React.forwardRef((props, ref) => (<div ref={ref} data-testid="email-dashboard-toolbar-action"/>));
    ...
    describe('All Expected Exports', () => {
        it('should export all expected components', () => {
            ...
            expectedComponentExports.forEach((exportName) => {
                ...
                const moduleAsRecord = DashboardLayoutModule;
        ...
        it('should not export any unexpected items', () => {
            ...
            const moduleAsRecord = DashboardLayoutModule;
            const runtimeExports = moduleKeys.filter((key) => typeof moduleAsRecord[key] !== 'undefined');

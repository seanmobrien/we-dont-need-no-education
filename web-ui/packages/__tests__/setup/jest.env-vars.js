export class MockEnvVarProvider {
    static snapshot() {
        const ret = Object.entries(process.env).reduce((acc, [key, _value]) => {
            acc[key] = process.env[key];
            return acc;
        }, {});
        return ret;
    }
    static apply(snapshot, merge = false) {
        const restoreKeys = new Set(Object.keys(snapshot));
...
const DefaultEnvVariables = {
    ...
    AZURE_APPLICATIONINSIGHTS_CONNECTION_STRING: 'azure-applicationinsights-connection-string',
    NEXT_PUBLIC_AZURE_MONITOR_CONNECTION_STRING: 'azure-applicationinsights-connection-string',
...
//# sourceMappingURL=jest.env-vars.js.map
...
export type { LoggedErrorOptions, ErrorLogFactory, TurtleRecursionParams, ErrorReportArgs, } from './logged-error/types';
export { isError, isAbortError, isProgressEvent, isXmlHttpRequest, getStackTrace, } from './utilities/error-guards';

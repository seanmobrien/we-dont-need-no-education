import type { ILogger, EventSeverity, ICustomAppInsightsEvent, SendCustomEventListener, SendCustomEventPayload } from './types';
export type { ILogger, EventSeverity, ICustomAppInsightsEvent, SendCustomEventListener, SendCustomEventPayload, };
...
export type { LoggedErrorOptions, ErrorLogFactory, TurtleRecursionParams, ErrorReportArgs, ErrorContext, IContextEnricher, SafeProgressEvent, } from './errors';

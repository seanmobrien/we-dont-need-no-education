declare module '@compliance-theater/logger/errors/utilities/safe-progress-event' {
  /**
   * The `SafeProgressEvent` type represents a ProgressEvent with guaranteed properties for length computability, loaded bytes, total bytes, and a typed target. 
   */

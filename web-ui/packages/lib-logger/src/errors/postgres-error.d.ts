 ...
 * @module @compliance-theater/logger/errors/postgres-error
 */

import type { IPostgresError } from "./types";

declare module '@compliance-theater/logger/errors/postgres-error' {
  ...
  export class PostgresError extends Error implements IPostgresError {
    ...
    static errorFromCode: (code: string | undefined | unknown) => string | undefined;
    
    code?: string;
    get codeDescription(): string | undefined;
    name: 'DrizzleError';
    detail?: string;
    hint?: string;
    position?: string;
    ...
    line?: string;
    routine?: string;
    query?: string; // Optional field for driver/wrapper-added query text
    parameters?: unknown[]; // Optional field for driver/wrapper-added query parameters
   ...
   */
  export function isDrizzleError(error: unknown): error is IPostgresError;
   ...
   */
  export type PG_ERROR_CODE_DESCRIPTIONS = {

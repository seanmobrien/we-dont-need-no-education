...
```typescript
import { preserveMessageStructure, createMessageStructureOptions } from '@compliance-theater/types/lib/ai/message-structure-preservation';
import type { MessageStructureOptions } from '@compliance-theater/types/lib/ai/message-structure-preservation';
...
```typescript
import { createPresetConfiguration } from '@compliance-theater/types/lib/ai/message-structure-preservation.t';
...
```typescript
import { validateMessageStructureOptions } from '@compliance-theater/types/lib/ai/message-structure-preservation.t';
...
} from '@compliance-theater/types/lib/ai/message-structure-preservation.t';

...
export const AiModelTypeValue_EmbeddingSmall = AiModelTypeValues[6];
export const AiModelTypeValue_GeminiPro = AiModelTypeValues[7];
export const AiModelTypeValue_GeminiFlash = AiModelTypeValues[8];
export const AiModelTypeValue_GoogleEmbedding = AiModelTypeValues[9];
export const AiModelTypeValue_Azure_LoFi = AiModelTypeValues[10];
export const AiModelTypeValue_Azure_HiFi = AiModelTypeValues[11];
export const AiModelTypeValue_Azure_Completions = AiModelTypeValues[12];
export const AiModelTypeValue_Azure_Embedding = AiModelTypeValues[13];
export const AiModelTypeValue_Google_Completions = AiModelTypeValues[14];
export const AiModelTypeValue_Google_Embedding = AiModelTypeValues[15];
export const AiModelTypeValue_Google_GeminiFlash_2dot0 = AiModelTypeValues[16];
 ...
 *
 * This type is derived by excluding the embedding model types (`AiModelTypeValue_Embedding`,
 * `AiModelTypeValue_EmbeddingSmall`, and `AiModelTypeValue_GoogleEmbedding`)
 * from the set of all available AI model types (`AiModelType`).
 *
 * @see AiModelType
 * @see AiModelTypeValue_Embedding
 * @see AiModelTypeValue_EmbeddingSmall
 * @see AiModelTypeValue_GoogleEmbedding
 */
export type AiLanguageModelType = Exclude<
  AiModelType,
  | typeof AiModelTypeValue_Embedding
  | typeof AiModelTypeValue_EmbeddingSmall
  | typeof AiModelTypeValue_GoogleEmbedding
>;

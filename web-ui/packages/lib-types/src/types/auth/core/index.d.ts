...
declare module '@auth/core' {
   ...
   * Used in OAuth provide`r profile callbacks and session callbacks.
   */
     ...
     *
     * This type extends the base NextAuth Account type to include
     ...
     *
     * This type   extends the base NextAuth Session type to include

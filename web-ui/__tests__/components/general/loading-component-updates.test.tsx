...
const LoadingWrapper = ({ loading, errorMessage }: { loading: boolean; errorMessage: string | null }) => (
...
describe('Loading Component Updates', () => {
  ...
  it('renders nothing when not loading and no error', () => {
    const { container } = render(<LoadingWrapper loading={false} errorMessage={null} />);

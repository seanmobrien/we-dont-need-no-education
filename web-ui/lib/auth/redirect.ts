 ...
 * @param {Object} props callback parameters
 * @param {string} props.url URL provided as callback URL by the client
 * @param {string} props.baseUrl Default base URL of site (can be used as fallback)

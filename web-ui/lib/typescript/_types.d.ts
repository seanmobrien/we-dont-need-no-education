/**
 * Type declarations for TypeScript utility types.
 *
 * @module _types
...
declare module '@/lib/typescript/_types' {
  /**
   ...
   * type PartialUser = PartialExceptFor<User, 'id'>; // { id: string; name?: string; email?: string; age?: number }
   * ```
   */
   ...
   *
   * @template T - The type whose keys should be extracted.
   *
   * @example
   * ```typescript

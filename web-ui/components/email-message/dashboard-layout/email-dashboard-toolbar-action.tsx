 ...
 * toolbar, including the theme selector for switching between light/dark themes and
 * the account component for user account management and authentication controls.

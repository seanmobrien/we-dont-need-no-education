          ...
          <ChatPanelLayout>
            <Container maxWidth="lg" sx={{ flex: 1, py: 2 }}>
              ...
              >
                ...
                <p>
                  This page demonstrates the chat panel docking functionality.
                </p>
                ...
                >
                  ...
                  <p>
                    When you dock the chat panel, this content area should
                    adjust to accommodate the docked panel:
                  </p>
                  <ul>
                    <li>
                      <strong>Dock Left:</strong> Main content should shift
                      right
                    </li>
                    <li>
                      <strong>Dock Right:</strong> Main content should shift
                      left
                    </li>
                    <li>
                      <strong>Dock Top:</strong> Main content should shift down
                    </li>
                    <li>
                      <strong>Dock Bottom:</strong> Main content should shift up
                    </li>
                    <li>
                      <strong>Float:</strong> Main content should remain
                      unchanged, panel floats over
                    </li>
                  </ul>

import type { AnyRecord, ToolDefinition } from "./types";
import { arrayOf, objectSchema, stringOrNumberSchema } from "./schema-utils";

export const readCaseFileOutputSchema = objectSchema({
...
export const caseFileTools: ToolDefinition[] = [
  {
    name: "get",
...
export const coreHelperTools: ToolDefinition[] = [
  {
    name: "read_case_file",
...
export const graphToolAliases: Record<string, string> = {
  graph_schema: "get-schema",
  graph_read: "read-cypher",
  graph_write: "write-cypher"
};

export const searchHelperTools: ToolDefinition[] = [
  {
    name: "embed",

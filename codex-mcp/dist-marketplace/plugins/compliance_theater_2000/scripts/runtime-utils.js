...
exports.httpDispatcherOptionsFromEnv = httpDispatcherOptionsFromEnv;
exports.sleep = sleep;
...
function httpDispatcherOptionsFromEnv() {
...
(0, undici_1.setGlobalDispatcher)(new undici_1.Agent(httpDispatcherOptionsFromEnv()));
function sleep(ms) {

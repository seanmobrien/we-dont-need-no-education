...
public class CallToActionCategoryEnvelope
  implements IRecordExtractionEnvelope<CallToActionCategory> {

  @Description(
    "Adds a Processing Note (📝⚙️) to the processing history of 🔔 category.  This is used to explain anomolies, " +
  ...
  List<CallToActionCategory> results;

  public CallToActionCategoryEnvelope() {
    this(null);
  }

  public CallToActionCategoryEnvelope(List<CallToActionCategory> results) {
    super();
    this.results = results == null ? List.of() : results;
  }

  @Override
  public List<CallToActionCategory> getResults() {
    return results;
  }
   ...
   */
  public void setResults(List<CallToActionCategory> results) {

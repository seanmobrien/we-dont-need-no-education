...
/*
 * Borrowed or stolen from https://github.com/smallrye/smallrye-llm/tree/main/smallrye-llm-langchain4j-telemetry
 *                                  Apache License
...
public class MetricsChatModelListener implements ChatModelListener {
  ...
  private static final String MP_AI_METRIC_START_TIME_NAME =
    "MP_AI_METRIC_START_TIME";

  private static final String METRIC_CLIENT_TOKEN_USAGE_NAME =
    "gen_ai.client.token.usage";
  private static final String METRIC_CLIENT_OPERATION_DURATION_NAME =
  ...
  public void onRequest(ChatModelRequestContext requestContext) {
    requestContext
      .attributes()
      .put(MP_AI_METRIC_START_TIME_NAME, System.nanoTime());
  }

  @Override
  public void onResponse(ChatModelResponseContext responseContext) {
    final long endTime = System.nanoTime();
    final long startTime = (Long) responseContext
      .attributes()
      .get(MP_AI_METRIC_START_TIME_NAME);
  ...
  public void onError(ChatModelErrorContext errorContext) {
    final long endTime = System.nanoTime();
    final long startTime = (Long) errorContext
      .attributes()
      .get(MP_AI_METRIC_START_TIME_NAME);
  ...
  private void recordClientOperationDuration(
